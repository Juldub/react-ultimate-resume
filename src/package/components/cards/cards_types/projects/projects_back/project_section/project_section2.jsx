...
import { SeeProjectDetail2 } from '../../see_project_detail/see_project_detail2';
...
const Details = ({ project, index, onDelete, classes }) => {
    ...
    return (
        <div className={classes.details}>
            ...
            <div className={classes.detail}>
                <SeeProjectDetail2 color={color} project={project} />
            </div>
...
export const ProjectSection2 = ProjectSectionContainer;
