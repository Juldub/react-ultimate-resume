...
const ExperiencesBackComponent = ({ data, handleAddButtonClick }) => {
    ...
    return (
        <ProfileCardAnimatedBack title="Je vous invite à me rejoindre durant les prochains temps forts">
            <Content {...{ data, handleAddButtonClick, classes }} />
        </ProfileCardAnimatedBack>
    );
};

export const ExperiencesBack2 = memo(ExperiencesBackComponent);
